...
const Login = () => {
  ...
  }, [session, router]); // Runs when session or router changes

  // If the session is available, show nothing while redirecting
  if (session) {
    return null; // Optionally, show a loading spinner instead of null
  }
  return (
    <div className='text-white container mx-auto py-6'>
     <h1 className='font-bold text-3xl text-center'>Login to Get Started</h1> 

     <div className="social-login-button w-1/2 flex flex-col mx:w-[25vw] justify-center mx-auto my-5">
